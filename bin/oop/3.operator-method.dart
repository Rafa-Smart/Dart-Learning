...
class AngkaList {
  ...
  // Object operator []=(int index, int value){
  //   while(index >= _data.length){
  //     _data.add(0);
  //     // jadi kalo tidak ada, maka kita tambahakan 0, lalu setelah
  //     // itu pada index yg dituju
  //     // baru kita ganti nilai 0 menjadi value
  //   }
  //   _data[index] = value;
  //   // lalu kita balikan
  //   return _data[index];
  ...
  // yg atas itu juga, ga bisa, karena harus return void
...
class MyList {
  ...
  Object operator [](int index){
    if(_internal.length <= index){
      return "Not Found Data $index";
    }else {
